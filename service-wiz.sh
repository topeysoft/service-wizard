...
wget -q -O "$SERVICE_FILE" 'https://raw.githubusercontent.com/topeysoft/service-wizard/master/service.sh'
chmod +x "$SERVICE_FILE"
echo ""

echo "--- Hello there. ---"
echo "I'll now ask you some question to customize script"
